...
<body class="helpbody">
  <section class='container'>
    ...
    <span>This media comes from an external source</span>
    ...
    <span>File name on site / Media URL</span>
    ...
    <span>Specify image/Create from original</span>
    ...
    <span>Store files in: Multimedia Folder / Collection Folder</span>
    ...
    <span>Owner/Source, Date Taken</span>
    ...
    <span>Link this media directly to the selected cemetery</span>
    ...
    <span>Show cemetery map and media whenever this item is displayed</span>
    ...
    <h4>Converting Media From One Collection to Another</h4>
    <p>To convert media items from one media type or "Collection" to another, check the Select box next to those items on the <a href="#search">Search</a> tab,
    ...
    <h4>Adding Media to Albums</h4>
    <p>To add media to an Album, check the Select box next to the items to be added, then select an Album from the dropdown box
    ...
    <span>Link to specific event</span>
    ...
    <span>Assign Default Photos</span>
    ...
    <span>Changing Title and Description</span>
