...
<body class="helpbody">
  <section class='container'>
    ...
    <p><span>Before Importing:</span> Use your desktop genealogy software to create a standard 5.5 GEDCOM file (4.0 will also work). You may choose to exclude
    ...
    <p><span>[Import GEDCOM] From your computer</span>
    ...
    <span>OR [Import GEDCOM] From web site (in GEDCOM folder)</span>
    ...
    <span>Accept data for all new Custom Event Types</span>
    ...
    <span>Import Custom Event Types Only (no data is added, replaced or appended)</span>
    ...
    <span>Replace matching records only</span>
    ...
    <span>Do not recalculate Living flag</span>
    ...
    <span>Replace only if newer</span>
    ...
    <span>Import media if present</span>
    ...
    <span>Start IDs at first available number/Start IDs at</span>
    ...
    <span>Exclude Living/Exclude Private</span>
    ...
    <span>Local paths for Photos/Documents/Headstones/Histories/Recordings/Videos</span>
