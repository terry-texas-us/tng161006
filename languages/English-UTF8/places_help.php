...
<body class="helpbody">
  <section class='container'>
    ...
    <h4>Add New / Edit Existing Places</h4>
    ...
    <span>Make changes to place name in existing events</span>
    ...
    <h4>Merging Places</h4>
    <p>To review and merge place names that may be slightly different but refer to the same location, click on the "Merge" tab. You will decide whether two
    records are the same or not.</p>

    <span>Find Merge Candidates</span>
    ...
    <span>Select Places to Merge</span>
    ...
    <span>If multiple results are found:</span>
