...
<body class="helpbody">
  <section class='container'>
    ...
    <span>Gender / Nickname / Title / Prefix / Suffix / Name Order</span>
    ...
    <p><span>LDS Data (Baptism, Confirmation, Initiatory, Endowment)</span><br />
    ...
    <span>Notes / Citations / Associations / "More"</span>
    ...
    <span>Sorting Parents or Spouses</span>
    ...
    <h4>Reviewing Tentative Edits</h4>
    <p>To review tentative edits made by other users, click on the "Review" tab. You will decide whether to keep or delete these proposed changes. Choose to review by tree, by user or both.
    ...
    <span>Select Event and Action</span><br />
    ...
    <span>Match the following fields</span><br />
    ...
    <p><span>Warning!</span> Once a merge has taken place, it cannot be undone! <em>Please consider backing up your database tables before
