...
<body class="helpbody">
  <section class='container'>
    ...
    <span>Box Height (w/o popups)</span>
    ...
    <span>Box Alignment (w/o popups)</span>
    ...
    <span>Box Height Shift (w/o popups)</span>
    ...
    <span>Show Notes on Register</span>
    <p>Indicates whether notes for individuals and families will be displayed on the Register page.</p>

    <span>Register Generations</span>
    <p>Choose to always show each person when displaying a generation, or avoid redundancy by electing to "Remove individuals
    ...
    <h4>Relationship Chart</h4>
    <span>Initial Relationships</span>
    ...
    <span>Vertical percentage for years</span>
    ...
    <span>Pixels between years</span>
    ...
    <span>Years between year markers</span>
    ...
    <span>Vertical percentage for months</span>
    <p>The event timeline is split vertically into sections for years and months. This value indicates what percentage
      of the vertical space (0-100) will be used to chart months.</p>

    <span>Pixels between months</span>
    ...
    <span>Box Horizontal Separation</span>
    ...
    <span>Box Vertical Separation</span>
    ...
    <span>Default PDF Page Size</span>
    ...
    <h4>Notes About Including Thumbnail Photos</h4>
