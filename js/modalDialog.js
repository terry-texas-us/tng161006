...
var ModalDialog = function (url, options) {
    ...
    this.options = {
        type: 'form',
        size: 'modal-md', // [ts] widths: modal-sm 300px modal-md 600px modal-lg 900px
        onremove: null,
        draggable: false, // [ts] jQuery-ui [not used]
        resizable: false, // [ts] jQuery-ui [not used]
        backdrop: true, // [ts] Includes a modal-backdrop element. Alternatively, specify static for a backdrop which doesn't close the modal on click.
        keyboard: true, // [ts] Closes the modal when escape key is pressed
        doneLoading: null
    };
