<!--<form name='treeform' action='admin_addtree.php' method='post' onsubmit="return validateTreeForm(this);" role='form'>-->
<form name='treeform' method='post' onsubmit="return validateTreeForm(this);" role='form'>
  <section class="card">
    ...
    <div class="card-block">
      ...
      <div class="footer">
        <label><input name='disallowgedcreate' type='checkbox' value='1'<?php if ($disallowgedcreate) {echo " checked";} ?>> <?php echo uiTextSnippet('gedcomextraction'); ?></label>
        <label><input name='disallowpdf' type='checkbox' value='1'<?php if ($disallowpdf) {echo " checked";} ?>> <?php echo uiTextSnippet('nopdf'); ?></label>
      </div>
    </div>
  </section> <!-- .card -->
  ...
  <section class="card">
    ...
    <div class="card-footer">
      <input class='btn btn-primary-outline pull-right' name='submit' type='submit' value="<?php echo uiTextSnippet('save'); ?>"> 
