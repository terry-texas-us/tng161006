...
<body>
  ...
  ORDER BY eventdatetr, $eventtypes_table.ordernum, tag, $notelinks_table.ordernum, ID";
      ...
      <?php
      if ($saveimport) {
        echo "<p>" . uiTextSnippet('ifexportfails') . " <a href=\"admin_gedcom2.php?tree=$tree&amp;resume=1\">" . uiTextSnippet('clickresume') . "</a>.</p>$lineending";
      }
      ...
      if ($savestate['lasttype'] < 2) {
        ...
        do {
          ...
          $query = "SELECT personID, $numstr as num, lastname, lnprefix, firstname, sex, title, prefix, suffix, nickname, birthdate, birthdatetr, birthplace, altbirthdate, altbirthdatetr, altbirthplace, deathdate, deathdatetr, deathplace, burialdate, burialdatetr, burialplace, burialtype, baptdate, baptplace, endldate, endlplace, famc, living, private, branch, DATE_FORMAT(changedate,\"%d %b %Y\") as changedate FROM $people_table
      ...
      <p>
        ...
        echo uiTextSnippet('finishedexporting')
                . " <br>{$savestate['icount']} " . uiTextSnippet('people')
      ...
      <p><a href="<?php echo "$gedpath/$tree" . ".ged" ?>"><?php echo uiTextSnippet('downloadged'); ?></a></p>
