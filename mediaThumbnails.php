...
//    $navList->appendItem([$allow_edit && !$assignedtree, "mediaThumbnails.php", uiTextSnippet('thumbnails'), "thumbs"]);
    $navList->appendItem([$allow_media_add, "mediaImport.php", uiTextSnippet('import'), "import"]);
