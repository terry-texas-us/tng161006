...
$query = "INSERT INTO $citations_table (gedcom, persfamID, eventID, sourceID, page, quay, citedate, citedatetr, citetext, note, description, ordernum)  VALUES('', '$persfamID', '$eventID', '$sourceID', '$citepage', '$quay', '$citedate', '$citedatetr', '$citetext', '$citenote', '', 999)";
