              ...
              <table>
                <tr>
                  ...
                  <td>
                    <table class='table table-sm'>
                      <tr>
                        <td><?php echo uiTextSnippet('places'); ?>:</td>
                        <td><input name='places_table' type='text' value="<?php echo $places_table; ?>"></td>
                      </tr>
                      <tr>
                  ...
                  <td>
                    <table class='table table-sm'>
                      <tr>
                        ...
                        <td><input name='trees_table' type='text' value="<?php echo $trees_table; ?>"></td>
                      </tr>
                      <tr>
            ...
            <div id="priv" style="display:none">
              <table>
                ...
                <tr>
                  ...
                  <td><span
                            id="trdisabled"<?php if ($requirelogin) {
                      echo " style=\"display:none\"";
                    } ?>><?php echo uiTextSnippet('reqloginset'); ?></span>
                    <select name="treerestrict"
                            id="treerestrict"<?php if (!$requirelogin) {
                      echo " style=\"display:none\"";
                    } ?>>
            ...
            <div id="cemeteries" style="display:none">
              <table>
                ...
                <tr>
                  ...
                  <td colspan='4'><input type='text' value="<?php echo $tngconfig['cemrows']; ?>"
                                         name="cemrows" size='5'></td>
                </tr>
                <tr>
        ...
        <tr>
          <td>
            ...
            <div id="mailreg" style="display:none">
              ...
              <table style="margin-left:5px;<?php if (!$tngconfig['usesmtp']) {
                echo " display:none";
              } ?>"
                     id="smtpstuff">
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    <select name="mailenc" id="mailenc">
                      <option
                              value=''<?php if (!$tngconfig['mailenc']) {
                        echo " selected";
                      } ?>></option>
                      <option
                              value="ssl"<?php if ($tngconfig['mailenc'] == "ssl") {
                        echo " selected";
                      } ?>>
                        ssl
                      </option>
                      <option
                              value="tls"<?php if ($tngconfig['mailenc'] == "tls") {
                        echo " selected";
                      } ?>>
                        tls
                      </option>
            ...
            <div id="misc" style="display:none">
              <table>
                ...
                <tr>
                  ...
                  <td>
                    <input name='time_offset' type='text' value="<?php echo $time_offset; ?>" size='5'>
                ...
                <tr>
                  ...
                  <td>
                    <select name="calstart">
                      ...
                      <option
                              value="3"<?php if ($tngconfig['calstart'] == "3") {
                        echo " selected";
                      } ?>><?php echo uiTextSnippet('wednesday'); ?></option>
                      <option
                              value="4"<?php if ($tngconfig['calstart'] == "4") {
                        echo " selected";
                      } ?>><?php echo uiTextSnippet('thursday'); ?></option>
                      <option
                              value="5"<?php if ($tngconfig['calstart'] == "5") {
                        echo " selected";
                      } ?>><?php echo uiTextSnippet('friday'); ?></option>
                      <option
                              value="6"<?php if ($tngconfig['calstart'] == "6") {
                        echo " selected";
                      } ?>><?php echo uiTextSnippet('saturday'); ?></option>
                    </select>
                  </td>
                </tr>
                <tr>
