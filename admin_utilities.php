      ...
      <div>
        <form action="" name='form1' id='form1' onsubmit="return startUtility(document.form1.withsel);">
          ...
          <table class="table table-sm table-striped">
            ...
            doRow('branches', uiTextSnippet('branches'));
            doRow('branchlinks', uiTextSnippet('brlinkstable'));
            doRow('cemeteries', uiTextSnippet('cemeteries'));
            doRow('children', uiTextSnippet('children'));
            ...
            doRow('mediatypes', uiTextSnippet('mediatypes'));
            ...
            doRow('saveimport', uiTextSnippet('saveimporttable'));
