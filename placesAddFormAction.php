...
$query = "INSERT IGNORE INTO places (place, placelevel, temple, latitude, longitude, zoom, notes, geoignore) VALUES ('$place', '$placelevel', '$temple', '$latitude', '$longitude', '$zoom', '$notes', '0')";
