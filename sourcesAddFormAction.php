...
$query = "INSERT INTO sources (sourceID, shorttitle, title, author, callnum, publisher, repoID, actualtext, changedate, changedby, type, other, comments) VALUES ('$sourceID', '$shorttitle', '$title', '$author', '$callnum', '$publisher', '$repoID', '$actualtext', '$newdate', '$currentuser', '', '', '')";
