...
function showCustEvents($id) {
  ...
  $query = "SELECT display, eventdate, eventplace, info, $events_table.eventID AS eventID FROM $events_table, $eventtypes_table "
      . "WHERE parenttag = \"\" AND persfamID = '$id' AND $events_table.eventtypeID = $eventtypes_table.eventtypeID ORDER BY eventdatetr, ordernum";
