...
$query = "UPDATE reports SET reportname=\"$reportname\",reportdesc=\"$reportdesc\",ranking=\"$ranking\",active=\"$active\",display=\"$display\",criteria=\"$criteria\",orderby=\"$orderby\",sqlselect=\"$sqlselect\" WHERE reportID=\"$reportID\"";
