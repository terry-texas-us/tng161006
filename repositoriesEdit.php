...
$query = "SELECT reponame, changedby, repositories.addressID, address1, address2, city, state, zip, country, phone, email, www, DATE_FORMAT(changedate,\"%d %b %Y %H:%i:%s\") AS changedate FROM repositories LEFT JOIN addresses ON repositories.addressID = addresses.addressID WHERE repoID = '$repoID'";
