<?php
/**
 * Name history: admin_associations.php
 */
require 'begin.php';
        ...
        <tbody id='associationstblbody'>
          ...
          if ($assocresult && $assoccount) {
            while ($assoc = tng_fetch_assoc($assocresult)) {
              ...
              if ($assoc['reltype'] == 'I') {
                $query = "SELECT firstname, lastname, lnprefix, nameorder, prefix, suffix, living, private, branch FROM people WHERE personID=\"{$assoc['passocID']}\"";
