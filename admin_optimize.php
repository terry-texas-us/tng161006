...
if ($table == 'all') {
  $tablelist = [$cemeteries_table, $people_table, $families_table, $children_table, $languagesTable, 'places', 'states', 'countries', $sources_table, $citations_table, $reports_table, $events_table, $eventtypes_table, 'trees', 'notelinks', 'xnotes', 'users', 'timelineevents', $saveimport_table, 'temp_events', $branches_table, $branchlinks_table, $address_table, $albums_table, $albumlinks_table, $album2entities_table, $assoc_table, $media_table, $medialinks_table, $mediatypes_table];
