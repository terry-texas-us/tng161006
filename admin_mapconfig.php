          ...
          <form action="admin_updatemapconfig.php" method='post' name='form1'>
            <table>
              <tr>
                ...
                <td>
                  <select name="mapkey">
                    <option value='1'<?php if ($map['key']) {
                      echo " selected";
                    } ?>><?php echo uiTextSnippet('yes'); ?></option>
                    <option value='0'<?php if (!$map['key']) {
                      echo " selected";
                ...
                <td>
                  <select name="maptype">
                    <option value="TERRAIN"<?php if ($map['displaytype'] == "TERRAIN") {
                      echo " selected";
                    } ?>><?php echo uiTextSnippet('mapterrain'); ?></option>
                    <option value="ROADMAP"<?php if ($map['displaytype'] == "ROADMAP") {
                      echo " selected";
                    } ?>><?php echo uiTextSnippet('maproadmap'); ?></option>
                    <option value="HYBRID"<?php if ($map['displaytype'] == "HYBRID") {
                      echo " selected";
                    } ?>><?php echo uiTextSnippet('maphybrid'); ?></option>
                    <option value="SATELLITE"<?php if ($map['displaytype'] == "SATELLITE") {
                      echo " selected";
                    } ?>><?php echo uiTextSnippet('mapsatellite'); ?></option>
                  </select>
                </td>
              </tr>
              <tr>
