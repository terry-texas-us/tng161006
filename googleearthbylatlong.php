...
header('Content-Disposition: inline; filename="tng.kml"');
...
?>
<kml xmlns="<?php echo $http; ?>://earth.google.com/kml/2.0">
  <Placemark>
    <description>
      This was found by lat/long data stored in your database.
    </description>
